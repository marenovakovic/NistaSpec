...
class GetBookmarkedProjects @Inject constructor(postExecutionThread: PostExecutionThread,
												private val projectsRepository: ProjectsRepository): ObservableUseCase<List<Project>, Nothing>(postExecutionThread) {

	override fun buildObservable(params: Nothing?): Observable<List<Project>> = projectsRepository.getBookmarkedProjects()
}